  ...
  (function() {
    ...
    window.initMap = function() {
      ...
      storeMarker = new google.maps.Marker({
        ...
        icon: {
          url: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><circle cx="20" cy="20" r="16" fill="#c47d91" stroke="#fff" stroke-width="3"/><text x="20" y="24" text-anchor="middle" font-size="16" fill="white">📍</text></svg>'),
