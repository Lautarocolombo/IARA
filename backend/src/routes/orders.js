...
const { getOrders, createOrder, updateOrderStatus, getUserOrders, deleteOrder, updateOrderNotes, getOrderDetail, exportOrders, getDashboardMetrics } = require('../controllers/ordersController');

router.get('/admin/orders', adminAuth, getOrders);
router.get('/admin/dashboard-metrics', adminAuth, getDashboardMetrics);
router.get('/admin/orders/export', adminAuth, exportOrders);
router.get('/orders', getUserOrders);
router.post('/orders', requireCustomHeader, createOrder);
