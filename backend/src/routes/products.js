...
const { getPublicProducts, getAdminProducts, createProduct, updateProduct, deleteProduct, searchProducts, syncToNeon, bulkImportProducts, toggleProductStatus, duplicateProduct } = require('../controllers/productsController');
